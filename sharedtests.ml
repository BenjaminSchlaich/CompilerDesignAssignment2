...
(*
  These tests are from the public github repository https://github.com/nicdard/compiler-design-eth-tests

  Some tests were removed since they test for constraints we don't enforce.
*)
...
let cc_xor1 = fun () -> Gradedtests.test_machine
  ...
  ;InsB0 (Xorq,  [Imm (Lit 0xFFFFFFFFF0F0F0F0L); ~%Rax]);InsFrag;InsFrag;InsFrag;InsFrag;InsFrag;InsFrag;InsFrag
  ]
...
let cc_xor2 = fun () -> Gradedtests.test_machine
  ...
  ;InsB0 (Xorq,  [Imm (Lit 0x1L); ~%Rax]);InsFrag;InsFrag;InsFrag;InsFrag;InsFrag;InsFrag;InsFrag
  ]

let cc_xor3 = fun () -> Gradedtests.test_machine
  [InsB0 (Movq, [Imm (Lit 0x0013402FL); ~%Rax]);InsFrag;InsFrag;InsFrag;InsFrag;InsFrag;InsFrag;InsFrag
  ;InsB0 (Xorq,  [Imm (Lit 0x1632FFL); ~%Rax]);InsFrag;InsFrag;InsFrag;InsFrag;InsFrag;InsFrag;InsFrag
  ]

let cc_xor4 = fun () -> Gradedtests.test_machine
  [InsB0 (Movq, [Imm (Lit 14L); ~%Rax]);InsFrag;InsFrag;InsFrag;InsFrag;InsFrag;InsFrag;InsFrag
  ;InsB0 (Xorq,  [Imm (Lit 0xF234567891012134L); ~%Rax]);InsFrag;InsFrag;InsFrag;InsFrag;InsFrag;InsFrag;InsFrag
  ]
...
let condition_flag_set_tests = 
  ...
  ; ("cc_xor1", Gradedtests.cs_test 2 (cc_xor1 ()) (false, true, false))
  ; ("cc_xor2", Gradedtests.cs_test 2 (cc_xor2 ()) (false, false, true))
  ; ("cc_xor3", Gradedtests.cs_test 2 (cc_xor3 ()) (false, false, false))
